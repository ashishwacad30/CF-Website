...
#     try:
#         # Format the delivery address to be passed into geocode_address
#         delivery_address = payload.community_name
#         user_location = (payload.latitude, payload.longitude)

#         result = validate_and_trigger_agents(user_location, delivery_address)
